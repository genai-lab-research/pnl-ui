...
const ChatContainer = styled('div')<{ expanded?: boolean }>(({ expanded }) => ({
  display: 'flex',
...
const MessagesContainer = styled('div')<{ expanded?: boolean }>(({ expanded }) => ({
  flex: 1,
  overflow: 'auto',
...
const MessageInputContainer = styled('div')<{ expanded?: boolean }>(({ expanded }) => ({
  padding: expanded ? '24px' : '16px',
