...
export const CheckboxStandard: React.FC<CheckboxStandardProps> = ({
  ...
  const CheckboxInput = () => (
    <div className="relative inline-flex items-center">
      ...
      />
      <span
        className={`w-5 h-5 border rounded flex-shrink-0 flex items-center justify-center 
          ${disabled 
  ...
  return (
    <label 
      className={`flex items-center ${containerClasses[labelPlacement]} ${disabled ? "cursor-not-allowed opacity-60" : "cursor-pointer"} ${className}`}
    >
      <CheckboxInput />
