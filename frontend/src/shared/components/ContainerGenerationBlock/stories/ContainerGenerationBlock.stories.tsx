...
import { ContainerGenerationBlock } from '../ContainerGenerationBlock';

const meta = {
  title: 'Shared/Components/ContainerGenerationBlock',
  component: ContainerGenerationBlock,
  parameters: {
    layout: 'centered',
  },
  tags: ['autodocs'],
} satisfies Meta<typeof ContainerGenerationBlock>;
