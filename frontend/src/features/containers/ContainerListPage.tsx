...
import { Column, ContainerType, ContainerPurpose, ContainerStatus } from '../../shared/types/containers';
    ...
    <Container maxWidth="xl">
      <Box sx={{ py: 4 }}>
        ...
        <Paper sx={{ p: 2, mb: 3 }}>
          ...
          <FilterChipContainer>
            <Typography variant="body2" sx={{ mr: 2 }}>Filter by:</Typography>
            
            <Chip 
              label="Physical" 
              onClick={() => setSelectedType(ContainerType.PHYSICAL)}
              onDelete={selectedType === ContainerType.PHYSICAL ? () => setSelectedType(null) : undefined}
            ...
            <Chip 
              ...
              onDelete={selectedType === ContainerType.VIRTUAL ? () => setSelectedType(null) : undefined}
            ...
            <Chip 
              ...
              onDelete={selectedPurpose === ContainerPurpose.DEVELOPMENT ? () => setSelectedPurpose(null) : undefined}
            ...
            <Chip 
              ...
              onDelete={selectedPurpose === ContainerPurpose.PRODUCTION ? () => setSelectedPurpose(null) : undefined}
            ...
            <Chip 
              ...
              onDelete={selectedStatus === ContainerStatus.ACTIVE ? () => setSelectedStatus(null) : undefined}
            ...
            <Chip 
              ...
              onDelete={selectedStatus === ContainerStatus.INACTIVE ? () => setSelectedStatus(null) : undefined}
