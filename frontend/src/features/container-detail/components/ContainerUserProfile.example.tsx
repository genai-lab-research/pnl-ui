    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '16px', padding: '16px' }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
        <ContainerUserProfile
          size="small"
          avatarUrl="https://via.placeholder.com/32x32/489F68/ffffff?text=JD"
          userName="John Doe"
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
        <ContainerUserProfile
          avatarUrl="https://via.placeholder.com/40x40/489F68/ffffff?text=JS"
          userName="Jane Smith"
          onClick={handleProfileClick}
        />
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
        <ContainerUserProfile
          size="large"
          avatarUrl="https://via.placeholder.com/48x48/489F68/ffffff?text=AB"
          userName="Alex Brown"
          onClick={handleProfileClick}
        />
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
        <ContainerUserProfile
          ...
          avatarUrl="https://via.placeholder.com/40x40/cccccc/666666?text=RO"
        />
