...
import { ContainerSummary, containerApi } from '../../shared/utils/api';
    ...
    <Container maxWidth="xl">
      <Box sx={{ py: 4 }}>
        <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 3 }}>
          <Typography variant="h4">{container ? container.name : 'Container'} Metrics</Typography>
          ...
          <ToggleButtonGroup
            ...
            size="small"
          >
            <ToggleButton value={MetricTimeRange.WEEK}>Week</ToggleButton>
            <ToggleButton value={MetricTimeRange.MONTH}>Month</ToggleButton>
            <ToggleButton value={MetricTimeRange.QUARTER}>Quarter</ToggleButton>
            <ToggleButton value={MetricTimeRange.YEAR}>Year</ToggleButton>
          </ToggleButtonGroup>
        </Box>
