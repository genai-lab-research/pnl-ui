...
export const apiConfig = {
  baseUrl: getEnvVar('VITE_API_BASE_URL', 'https://pnl-api-gen-v2-c6bahbgpbcdrh9br.centralus-01.azurewebsites.net/api/v1'),
  talk2dbUrl: getEnvVar('VITE_TALK_TO_DB_API_URL', 'https://pnl-talk2db-deployment-41.wittybeach-dd75971c.centralus.azurecontainerapps.io'),
  timeout: 30000,
};