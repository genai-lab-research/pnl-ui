...
describe('Performance API', () => {
  describe('Performance overview', () => {
    it('should retrieve performance metrics with default time range (WEEK)', async () => {
    ...
    it('should retrieve performance metrics for MONTH time range', async () => {
    ...
    it('should retrieve performance metrics for QUARTER time range', async () => {
      const performance = await performanceService.getPerformanceOverview(MetricTimeRange.QUARTER);
    ...
    it('should retrieve performance metrics for YEAR time range', async () => {
