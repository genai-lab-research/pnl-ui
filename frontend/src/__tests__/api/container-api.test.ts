...
describe('Container API', () => {
  ...
  describe('Container creation', () => {
    ...
    it('should validate container data client-side', async () => {
    ...
    it('should return error when creating a container with duplicate name', async () => {
      // First get a valid tenant to use
      const tenantResponse = await tenantService.getTenants();
      const tenant = tenantResponse.results[0];
  ...
  describe('Container retrieval', () => {
    it('should retrieve container list', async () => {
