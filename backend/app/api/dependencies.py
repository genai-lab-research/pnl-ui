...
async def get_container_filters(
    ...
    purpose: Optional[str] = Query(None, description="Filter by purpose (development/research/production/testing)"),
    ...
    # Validate purpose
    if purpose and purpose not in ["development", "research", "production", "testing"]:
        raise HTTPException(
            status_code=422,
            detail="Invalid purpose. Must be 'development', 'research', 'production', or 'testing'"
        )
