...
class TestContainerEndpoints:
    ...
    def test_get_container_metrics_with_time_range(self, client: TestClient):
        ...
        container_id = "container-04"
        response = client.get(
            f"/api/v1/containers/{container_id}/metrics?time_range=WEEK"
        )
    ...
    def test_get_container_crops_with_pagination(self, client: TestClient):
        ...
        container_id = "container-04"
        response = client.get(
            f"/api/v1/containers/{container_id}/crops?page=0&page_size=2"
        )
    ...
    def test_get_container_crops_with_seed_type_filter(self, client: TestClient):
        ...
        seed_type = "Kiribati"
        response = client.get(
            f"/api/v1/containers/{container_id}/crops?seed_type={seed_type}"
        )
    ...
    def test_get_container_activities_with_limit(self, client: TestClient):
        ...
        limit = 3
        response = client.get(
            f"/api/v1/containers/{container_id}/activities?limit={limit}"
        )
    ...
    def test_create_container_success(self, client: TestClient):
        ...
        container_data = {
            ...
            "system_integrations": {
                ...
                "aws_environment": {"name": "Test", "enabled": True},
...
class TestContainerValidation:
    ...
    def test_get_container_metrics_invalid_time_range(self, client: TestClient):
        ...
        container_id = "container-04"
        response = client.get(
            f"/api/v1/containers/{container_id}/metrics?time_range=INVALID"
        )
